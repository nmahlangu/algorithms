...
class Solution:
    ...
    def calc_greedy_min_boxes_for_capacity(self, quantities: list[int], capacity: int) -> int:
        count: int = 0
        for q in quantities:
    ...
    def minimumShippingCapacity(self, quantities: list[int], maxBoxes: int):
        ...
        while left < right:
            ...
            num_boxes: int = self.calc_greedy_min_boxes_for_capacity(quantities=quantities, capacity=mid)
...
class TestSolution(unittest.TestCase):
    ...
    def test2(self):
        actual = Solution().minimumShippingCapacity(quantities=[3,6,7,11], maxBoxes=8)
